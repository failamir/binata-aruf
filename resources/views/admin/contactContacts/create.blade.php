    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contact-contacts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tempat_tanggal_lahir') ? 'is-invalid' : '' }}" type="text" name="tempat_tanggal_lahir" id="tempat_tanggal_lahir" value="{{ old('tempat_tanggal_lahir') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('domisili_saat_ini') ? 'is-invalid' : '' }}" type="text" name="domisili_saat_ini" id="domisili_saat_ini" value="{{ old('domisili_saat_ini', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_handphone') ? 'is-invalid' : '' }}" type="number" name="nomor_handphone" id="nomor_handphone" value="{{ old('nomor_handphone', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nomor_whats_app') ? 'is-invalid' : '' }}" type="number" name="nomor_whats_app" id="nomor_whats_app" value="{{ old('nomor_whats_app', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alamat_email') ? 'is-invalid' : '' }}" type="text" name="alamat_email" id="alamat_email" value="{{ old('alamat_email', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akun_facebook') ? 'is-invalid' : '' }}" type="text" name="akun_facebook" id="akun_facebook" value="{{ old('akun_facebook', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akun_telegram') ? 'is-invalid' : '' }}" type="text" name="akun_telegram" id="akun_telegram" value="{{ old('akun_telegram', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akun_twitter') ? 'is-invalid' : '' }}" type="text" name="akun_twitter" id="akun_twitter" value="{{ old('akun_twitter', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('akun_tiktok') ? 'is-invalid' : '' }}" type="text" name="akun_tiktok" id="akun_tiktok" value="{{ old('akun_tiktok', '') }}">
